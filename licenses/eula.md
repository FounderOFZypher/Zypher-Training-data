...
By downloading, accessing, installing, copying, or using the Dataset under an **enterprise agreement**, you agree to be bound by this Agreement in conjunction with the [Coltex Enterprise License](enterprise.md). For other tiers, see the [Personal License](personal.md) ($79) or [Professional License](professional.md) ($399).
